...
namespace shark {
    ...
    EnsembleDataModel::EnsembleDataModel() {
    }
    ...
    void EnsembleDataModel::loadHeader (std::ifstream &modelDataStream) {
...
//    unsigned int nr_sv = 0;
    ...
    void EnsembleDataModel::load (std::string filePath) {
        ...
        if (!stream.good())
            throw SHARKSVMEXCEPTION ("[EnsembleDataModel::load] failed to open file for input");
    ...
    void EnsembleDataModel::save (std::string filePath) {
        ...
        switch (container -> m_svmType) {
            ...
            default: {
                throw (SHARKSVMEXCEPTION ("[EnsembleDataModel::save] Unsupported SVM type."));
            }
        }
    ...
    unsigned int EnsembleDataModel::numberOfPositiveSV() {
    ...
    unsigned int EnsembleDataModel::numberOfNegativeSV() {
    ...
    void EnsembleDataModel::saveHeader (std::ofstream &modelDataStream) {
    ...
    void EnsembleDataModel::loadSparseLabelAndData (DataModelContainerPtr container, std::ifstream &modelDataStream) {
    ...
    void EnsembleDataModel::saveSparseLabelAndData (DataModelContainerPtr container, std::ifstream &modelDataStream) {
