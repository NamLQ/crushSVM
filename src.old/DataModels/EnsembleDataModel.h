...
#ifndef SHARK_ENSEMBLEDATAMODEL_H
#define SHARK_ENSEMBLEDATAMODEL_H
...
//! \sa
    ...
    class EnsembleDataModel : public AbstractSVMDataModel {
        private:
        ...
        public:
            ...
            virtual ~EnsembleDataModel();


            /// \brief From INameable: return the class name.
            std::string name() const {
                return "EnsembleDataModel";
            }
